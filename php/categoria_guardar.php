<?php
    ...
    /*== Almacenando datos ==*/
    $nombre=LimpiarCadena($_POST['categoria_nombre']);
    $ubicacion=LimpiarCadena($_POST['categoria_ubicacion']);
    ...
    $guardar_categoria=$guardar_categoria->prepare("INSERT INTO Categoria (nombre,ubicacion) VALUES(:nombre,:ubicacion)");
